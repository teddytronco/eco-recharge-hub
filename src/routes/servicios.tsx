...
import { BulletList, EmergencyNotice, PageHero, Section, SectionTitle } from "@/components/site/blocks";
...
const copy = {
  es: {
    ...
    items: [
      ...
      { t: "Manejo y almacenamiento especializado", d: "Control del material antes y durante su traslado.", b: ["Segregación por química y condición", "Aislamiento y contención", "Manejo de unidades dañadas sujeto a evaluación"] },
    ...
    scopeBody: "Atendemos baterías de vehículos eléctricos, BESS, herramientas, electrónicos, electrodomésticos e industria en México, Centroamérica y Sudamérica.",
  ...
  en: {
    ...
    items: [
      ...
      { t: "Specialized handling and storage", d: "Control of material before and during transport.", b: ["Separation by chemistry and condition", "Insulation and containment", "Damaged units subject to assessment"] },
    ...
    scopeBody: "We support EV, BESS, power-tool, electronics, appliance and industrial batteries across Mexico, Central America and South America.",
